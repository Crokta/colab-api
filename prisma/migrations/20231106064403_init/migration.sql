...
-- CreateIndex
CREATE INDEX "member_profileId_serverId" ON "Member"("profileId", "serverId");

-- CreateIndex
CREATE INDEX "channel_profileId_serverId" ON "Channel"("profileId", "serverId");

-- CreateIndex
CREATE INDEX "message_memberId_channelId" ON "Message"("memberId", "channelId");

-- CreateIndex
CREATE INDEX "directMessage_memberId_conversationId" ON "DirectMessage"("memberId", "conversationId");
